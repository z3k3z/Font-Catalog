...
class RegistryDiscovery:
    ...
    def _collect_registry_font_candidates_from_key(
        ...
        font_candidates: list[FontCandidate] = self._collect_registry_font_candidates_from_open_key(
    ...
    def _resolve_registry_font_path(
        ...
        if candidate_path.is_absolute():
            ...
            resolved_path = self._applicationConfiguration.windows_font_directory / candidate_path
